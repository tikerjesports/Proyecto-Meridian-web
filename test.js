...
// ============================================================
const SUBCAT_DATA = {
    category: "Meridian Test Series",
    game: "CS:GO",          // "CS:GO" | "LoL" | "Valorant"
    format: "BO1",
    status: "live",         // "live" | "upcoming" | "completed"
    logoSrc: "assets/logos/meridian-test-series.png",
    description: "Torneos de nivel básico utilizados para probar equipos y permitir que nuevos equipos entren al ecosistema de Meridian.",
    ...
    standings: [
        ...
        { teamId: 3, pj: 3, v: 2, d: 1, mapDiff: 1, pts: 6 },
        { teamId: 4, pj: 3, v: 2, d: 1, mapDiff: 1, pts: 6 },
        { teamId: 5, pj: 3, v: 1, d: 2, mapDiff: -2, pts: 3 },
        { teamId: 6, pj: 3, v: 1, d: 2, mapDiff: -2, pts: 3 },
        { teamId: 7, pj: 3, v: 1, d: 2, mapDiff: -3, pts: 3 },
        { teamId: 8, pj: 3, v: 0, d: 3, mapDiff: -5, pts: 0 },
    ],

    bracket: {
        semifinals: [
            { id: 's1', top: { teamId: 1, score: 2 }, bottom: { teamId: 4, score: 0 }, status: 'completed', format: 'BO3' },
            { id: 's2', top: { teamId: 2, score: 1 }, bottom: { teamId: 3, score: 1 }, status: 'live', format: 'BO3' }
        ],
        final: [
            { id: 'f1', top: { teamId: 1, score: 0 }, bottom: { teamId: null, score: 0 }, status: 'upcoming', format: 'BO3' }
        ]
    },

    teamStats: [
        { teamId: 1, pj: 4, v: 4, d: 0, mapDiff: 8, pts: 12 },
        { teamId: 2, pj: 3, v: 2, d: 1, mapDiff: 2, pts: 6 },
        { teamId: 3, pj: 3, v: 2, d: 1, mapDiff: 1, pts: 6 },
        { teamId: 4, pj: 4, v: 2, d: 2, mapDiff: -1, pts: 6 },
        { teamId: 5, pj: 3, v: 1, d: 2, mapDiff: -2, pts: 3 },
        { teamId: 6, pj: 3, v: 1, d: 2, mapDiff: -2, pts: 3 },
        { teamId: 7, pj: 3, v: 1, d: 2, mapDiff: -3, pts: 3 },
        { teamId: 8, pj: 3, v: 0, d: 3, mapDiff: -5, pts: 0 },
...
function renderLeagueTable() {
    ...
    const qualifyZone = 4;   // top 4 qualify to playoffs

    data.forEach((row, i) => {
        const pos     = i + 1;
        const team    = getTeam(row.teamId);
        const posClass= pos === 1 ? 'pos-1' : pos === 2 ? 'pos-2' : pos === 3 ? 'pos-3' : '';
        const rowClass= pos <= qualifyZone ? 'qualify-zone' : 'relegation-zone';
